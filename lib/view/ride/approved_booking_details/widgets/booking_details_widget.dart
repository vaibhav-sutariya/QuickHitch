...
class BookingDetailsWidget extends StatelessWidget {
  final BookingRequestData
      ride; // Assuming RideModel contains the required data.

  const BookingDetailsWidget({super.key, required this.ride});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: AppColors.greenColor2.withOpacity(0.1),
          border: Border(
            bottom: BorderSide(color: AppColors.greenColor2, width: 1.0),
