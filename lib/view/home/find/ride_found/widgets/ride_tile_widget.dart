      ...
      builder: (context, value, child) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            final ride = data[index].ride;
            return InkWell(
              onTap: () {
                Navigator.pushNamed(context, RoutesName.foundViewRideScreen,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                const SizedBox(width: 10),
                                Text(
                                    '${data[index].ride!.driver!.rating ?? 0.0}',
                                    style: const TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w400,
                                      color: AppColors.lightColor,
                      ...
                      children: [
                        Text(
                          DateFormat('dd/MM/yyyy | hh:mm a')
                              .format(DateTime.parse(ride.departureDate!)),
                          style: const TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w400,
                            color: AppColors.darkColor,
                        ...
                        Text('${data[index].emptySeats} Seats left',
                            style: const TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w400,
                              color: AppColors.lightColor,
